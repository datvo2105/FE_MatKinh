                    ...
                    <td className="cart__update-wrapper cart-flex-item text-right">
                      <div className="cart__qty text-center">
                        <div className="qtyField">
                          <a className="qtyBtn minus" href="event.default();">
                          ...
                          <input
                            ...
                            pattern="[0-9]*"
                          />
                          <a className="qtyBtn plus" href="event.default();">
                ...
                <form action="#" method="post">
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option defaultValue="Afghanistan" data-provinces="[]">
                        Afghanistan
                      </option>
                      <option defaultValue="Aland Islands" data-provinces="[]">
                        Åland Islands
                      </option>
                      ...
                      <option defaultValue="Bouvet Island" data-provinces="[]">
                        Bouvet Island
                      </option>
                      <option
                      ...
                      <option defaultValue="Burkina Faso" data-provinces="[]">
                        Burkina Faso
                      </option>
                      ...
                      <option defaultValue="Cayman Islands" data-provinces="[]">
                        Cayman Islands
                      </option>
                      <option
                      ...
                      <option defaultValue="Cook Islands" data-provinces="[]">
                        Cook Islands
                      </option>
                      ...
                      <option defaultValue="Czech Republic" data-provinces="[]">
                        Czech Republic
                      </option>
                      <option defaultValue="Côte d'Ivoire" data-provinces="[]">
                        Côte d'Ivoire
                      </option>
                      ...
                      <option defaultValue="French Guiana" data-provinces="[]">
                        French Guiana
                      </option>
                      <option
                      ...
                      <option defaultValue="Liechtenstein" data-provinces="[]">
                        Liechtenstein
                      </option>
                      ...
                      <option defaultValue="Netherlands" data-provinces="[]">
                        Netherlands
                      </option>
                      ...
                      <option defaultValue="Saudi Arabia" data-provinces="[]">
                        Saudi Arabia
                      </option>
                      ...
                      <option defaultValue="Sierra Leone" data-provinces="[]">
                        Sierra Leone
                      </option>
                      <option defaultValue="Singapore" data-provinces="[]">
                        Singapore
                      </option>
                      <option defaultValue="Sint Maarten" data-provinces="[]">
                        Sint Marteen
                      </option>
                      ...
                      <option defaultValue="Saint Helena" data-provinces="[]">
                        St. Helena
                      </option>
                      <option
                      ...
                      <option defaultValue="Saint Lucia" data-provinces="[]">
                        St. Lucia
                      </option>
                      <option defaultValue="Saint Martin" data-provinces="[]">
                        St. Martin
                      </option>
                      <option
                      ...
                      <option defaultValue="St. Vincent" data-provinces="[]">
                      ...
                      <option defaultValue="Switzerland" data-provinces="[]">
                        Switzerland
                      </option>
                      ...
                      <option defaultValue="Timor Leste" data-provinces="[]">
                        Timor-Leste
                      </option>
                      ...
                      <option defaultValue="Turkmenistan" data-provinces="[]">
                        Turkmenistan
                      </option>
                      <option
                      ...
                      <option defaultValue="United Kingdom" data-provinces="[]">
                        United Kingdom
                      </option>
                      ...
                      <option defaultValue="Western Sahara" data-provinces="[]">
                        Western Sahara
                      </option>
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option defaultValue="Mississippi">Mississippi</option>
                      ...
                      <option defaultValue="North Dakota">North Dakota</option>
                      ...
                      <option defaultValue="Pennsylvania">Pennsylvania</option>
                      <option defaultValue="Puerto Rico">Puerto Rico</option>
                      <option defaultValue="Rhode Island">Rhode Island</option>
                      <option defaultValue="South Carolina">
                        South Carolina
                      </option>
                      <option defaultValue="South Dakota">South Dakota</option>
