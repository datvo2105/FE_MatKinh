    ...
    <>
      <div className="page section-header text-center mb-0">
        <div className="page-title">
          <div className="wrapper">
            <h1 className="page-width">Blog Article</h1>
          </div>
        </div>
      </div>
      <div className="bredcrumbWrap">
        <div className="container breadcrumbs">
          ...
          <a href="blog-left-sidebar.html" title="Back to News">
            News
          </a>
          <span aria-hidden="true">›</span>
              ...
              <div className="article">
                ...
                <div className="rte">
                  <p>
                    ...
                    cas comparable avec celle du français standard. De
                    nombreuses suites logicielles de.
                  </p>
                  <p>
                  ...
                  <ul className="list-items">
                    <li>
                      Donec et lacus mattis ipsum feugiat interdum non id
                      sapien.
                    </li>
                    <li>
                      Quisque et mauris eget nisi vestibulum rhoncus molestie a
                      ante.
                    </li>
                  ...
                  <h3>
                    Donec maximus quam at lectus bibendum, non suscipit nunc
                    tristique.
                  </h3>
                  <p>
                  ...
                  <div className="row">
                    <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                      <p className="fine-print">
                        Please note, comments must be approved before they are
                        published
                      </p>
                      <input
                        type="submit"
